				...
				<tr>
					...
					<td>
						...
						<a class="btnEdit"
							...
							rel="modifyDialog" title="指标信息更新" mask="true" width="540"
							height="300">修改</a> &nbsp; &nbsp;
					</td>
					<td>
						&nbsp;
						<a class="btnView"
							href="${ctx}/shortMessage/view/${entity.id}.html" target="dialog"
							rel="modifyDialog" width="880" height="520" title="任务查看"
							mask="true">查看</a>
					</td>
