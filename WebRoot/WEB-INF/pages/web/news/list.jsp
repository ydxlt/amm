...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath}/web/news/list.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="${pageContext.request.contextPath}/web/news/list.html" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${pageContext.request.contextPath}/web/news/new.html" target="navTab" rel="addNewsNavTab" title="网站内容新增" max=true><span>添加</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" href="${pageContext.request.contextPath}/web/news/nopublish.html" target="selectedTodo" rel="items" title="确定要取消发布吗?"><span>取消发布</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" href="${pageContext.request.contextPath}/web/news/delete.html" target="selectedTodo" rel="items" title="确定要删除吗?"><span>批量删除</span></a></li>
		</ul>
	</div>
